        ...
        <>
            <ScreenPage>
                ...
                {userS.logged == true && (
                    ...
                    <div className={`mt-20 flex items-center gap-[10px] absolute top-0 left-0 m-3`}>
                        <img
                            src={img}
                            alt=""
                        ...
                        <input
                            ...
                            className={`text-[22px] font-bold capitalize bg-transparent border-2 border-my-quartenary p-1 ps-2 rounded-[15px] outline-none
                            ${theme == 'light'
                            ? 'text-my-black'
                            : 'text-my-white'}`}
                            value={name}
                ...
                <div className={`mt-32 px-14 w-full flex justify-center flex-wrap gap-[20px]`}>
                    <img
                        onClick={() => toggleImg(1)}
                        className={`w-[90px] rounded-[50%] border-2 border-my-primary`}
                        src={avatar_1} alt=""
                    />
                    <img
                        onClick={() => toggleImg(2)}
